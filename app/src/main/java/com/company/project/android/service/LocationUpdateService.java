package com.company.project.android.service;

/**
 * @author Administrator
 * @name MyMvp
 * @class name：com.company.project.android.service
 * @class describe
 * @time 2018/4/24 16:18
 * @change
 * @class describe
 */
...
public class LocationUpdateService extends IntentService {
    ...
    private synchronized void getBestLocationProvider() {//synchronized 是Java语言的关键字，当它用来修饰一个方法或者一个代码块的时候，能够保证在同一时刻最多只有一个线程执行该段代码。
        ...
        for (String provider:providers) {
            LogUtils.i("Alex","发现位置传感器"+provider);
        }
    ...
    private void updateLocation() {
        Log.i("gps","当前纬度是:"+(locationProvider != null));
